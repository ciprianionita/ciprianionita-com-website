...
export default function Project({
    ...
    return (
        ...
        >
            <section className="bg-white/10 max-w-[50rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-white/20 transition sm:pl-8 text-white">
